...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Redirect handled by App.jsx or Router based on auth state
        } catch (err) {
                ...
                <div className="bg-surfaceCard p-8 rounded-2xl shadow-2xl border border-border/20">
                    ...
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex justify-end mt-2">
                                <a href="#" onClick={(e) => { e.preventDefault(); window.location.hash = '#recover' }} className="text-xs text-textTitle hover:text-primary transition-colors">
                                    Esqueceu a senha?
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="px-2 bg-surfaceCard text-textSecondary uppercase tracking-wider">ou</span>
                        </div>
                    </div>

                    <Button type="button" variant="outline" onClick={handleGoogleLogin} className="w-full !bg-transparent !border-border !text-textMain hover:!bg-white/5 !font-normal">
                    ...
                    <div className="text-center mt-6">
                        ...
                        >
                            Não tem uma conta? <span className="font-bold text-primary">Cadastre-se</span>
                        </button>
                    </div>
                </div>
            </div>
