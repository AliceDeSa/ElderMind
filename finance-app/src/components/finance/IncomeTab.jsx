        ...
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end flex-wrap sm:flex-nowrap">
                    ...
                    {!showForm && (
                        <Button onClick={() => setShowForm(true)} className="!w-auto shrink-0 !py-2 px-4 text-xs md:text-sm font-bold whitespace-nowrap">
                            <Plus size={16} className="mr-1.5" /> {t('finance:income.addButton')}
                        </Button>
                    )}
                </div>
            </div>
